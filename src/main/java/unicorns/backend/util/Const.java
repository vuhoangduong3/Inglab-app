...
public class Const {
    ...
    public static final String PREFIX_STUDENTANSWER_V1 = PREFIX_UNICORNS_SERVICE_V1 + "exercise/";
    public static final String PREFIX_CLASS_V1 = PREFIX_UNICORNS_SERVICE_V1 + "class/";
    public static final String PREFIX_SCHEDULE_V1 = PREFIX_UNICORNS_SERVICE_V1 + "schedule/";
}
